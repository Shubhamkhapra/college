...
--
-- Host: localhost
-- Generation Time: May 29, 2022 at 07:31 PM
...
INSERT INTO `employees1` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`) VALUES
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `employees1` (`employeeNumber`);

--
-- Constraints for table `employees1`
--
ALTER TABLE `employees1`
  ADD CONSTRAINT `employees1_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `employees1` (`employeeNumber`),
  ADD CONSTRAINT `employees1_ibfk_2` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`);
